    ...
    <div className="space-y-6">
      <section className="rounded-[32px] border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
        ...
        <p className="mt-3 max-w-4xl text-sm leading-7 text-slate-600 sm:text-base">
          Monitor platform-wide appointment bookings, filter by status and payment,
          review upcoming schedules, and export appointment records when needed.
        </p>
      </section>
      ...
      <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-5">
        ...
        <div className="rounded-2xl border border-blue-200 bg-blue-50 p-5 shadow-sm">
          ...
          <p className="mt-2 text-3xl font-bold text-blue-800">{summary.completed}</p>
        </div>
        <div className="rounded-2xl border border-sky-200 bg-sky-50 p-5 shadow-sm">
          <p className="text-xs font-semibold uppercase tracking-[0.18em] text-sky-700">
            Paid
          </p>
          <p className="mt-2 text-3xl font-bold text-sky-800">{summary.paid}</p>
        </div>
      </section>
      ...
      <section className="overflow-hidden rounded-[28px] border border-slate-200 bg-white shadow-sm">
        <div className="border-b border-slate-200 px-6 py-5">
          <div className="flex flex-col gap-4 xl:flex-row xl:items-end xl:justify-between">
            <div>
              <h2 className="text-2xl font-bold text-slate-900">Appointments Table</h2>
              <p className="mt-2 text-sm leading-6 text-slate-500">
                Search, filter, paginate, and export appointment records across the
                platform.
              </p>
            </div>
          ...
          <div className="mt-5 grid gap-3 xl:grid-cols-[minmax(260px,1.5fr)_1fr_1fr_140px]">
            <input
              value={searchTerm}
              onChange={(event) => setSearchTerm(event.target.value)}
              placeholder="Search by doctor, specialty, date, time, reason, payment..."
